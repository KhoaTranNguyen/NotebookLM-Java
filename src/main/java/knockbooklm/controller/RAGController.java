...
import knockbooklm.controller.base_class.PdfDocumentParser;
import knockbooklm.controller.base_splitter.MyDocumentSplitter;
import knockbooklm.controller.base_splitter.MyDocumentSplitters;
import knockbooklm.model.dao.DocumentDao;
...
public class RAGController {
    ...
    public int ingestDocument(long userId, File pdfFile) {
        try (FileInputStream inputStream = new FileInputStream(pdfFile)) {
            ...
            knockbooklm.model.Document dbDoc = new knockbooklm.model.Document();
